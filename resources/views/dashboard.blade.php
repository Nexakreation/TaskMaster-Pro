        ...
        <script>
            function stickyWall() {
                return {
                    ...
                    async loadNotes() {
                        try {
                            const response = await fetch('taskmaster-pro/public/api/notes');
                    ...
                    async drop(event, targetNote) {
                        ...
                        try {
                            await fetch('taskmaster-pro/public/api/notes/reorder', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                    ...
                    async deleteNote(noteId) {
                        ...
                        try {
                            await fetch(`taskmaster-pro/public/api/notes/${noteId}`, {
                                method: 'DELETE',
                                headers: {
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                                }
                    ...
                    async updateNote() {
                        ...
                        try {
                            const response = await fetch(`taskmaster-pro/public/api/notes/${this.editingNote.id}`, {
                                method: 'PATCH',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
